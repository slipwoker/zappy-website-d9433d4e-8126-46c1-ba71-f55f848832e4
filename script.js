document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function getFieldError(field) {
      ...
      if ((type === 'tel' || name.toLowerCase().includes('phone') || name.toLowerCase().includes('tel')) && !validators.phone(value)) {
  ...
  function applyInitialStyles(el) {
    if (!el.classList.contains('fade-in-visible')) {
      ...
      el.style.transform = el.getAttribute('data-animate-from') || 'translateY(24px)';
      el.style.transition = 'opacity 0.6s ease ' + (el.getAttribute('data-animate-delay') || '0s') + ', transform 0.6s ease ' + (el.getAttribute('data-animate-delay') || '0s');
    }
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שוטף אדומים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'd9433d4e-8126-46c1-ba71-f55f848832e4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'd9433d4e-8126-46c1-ba71-f55f848832e4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'd9433d4e-8126-46c1-ba71-f55f848832e4';
